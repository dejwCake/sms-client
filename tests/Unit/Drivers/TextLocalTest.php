...
#[CoversClass(TextLocal::class)]
final class TextLocalTest extends TestCase
{
    private function makeDriver(GuzzleInterface $client, ResponseInterface $response, array $config = [
        'apiKey' => 'blah',
    ],): TextLocal
    {
        return new TextLocal($client, $response, $config);
    }
    ...
    public function testIsInitializable(): void
    {
        ...
        self::assertInstanceOf(TextLocal::class, $driver);
    }
    ...
    public function testReturnsTheDriverName(): void
    {
        ...
        $response = $this->createStub(ResponseInterface::class);
        $driver = $this->makeDriver($client, $response);
        self::assertSame('TextLocal', $driver->getDriver());
    }
    ...
    public function testReturnsTheDriverEndpoint(): void
    {
        ...
        $response = $this->createStub(ResponseInterface::class);
        $driver = $this->makeDriver($client, $response);
        self::assertSame('https://api.txtlocal.com/send/', $driver->getEndpoint());
    }
